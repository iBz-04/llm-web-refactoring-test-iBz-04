/**
 * @file packages/ui/src/tokens/typography.stylex.ts
 * @contents Shared UI package module (typography.stylex.ts).
 * @use Imported by client apps that depend on `@chirp/ui`.
 */
