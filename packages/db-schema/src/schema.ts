/**
 * @file packages/db-schema/src/schema.ts
 * @contents Drizzle table definitions for SQLite (users, posts, moderation, etc.).
 * @use Imported by `@chirp/api` and any package that types or migrates the database schema.
 */
