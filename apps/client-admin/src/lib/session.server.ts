/**
 * @file apps/client-admin/src/lib/session.server.ts
 * @contents TanStack Start encrypted cookie session for admin/moderator (`userId`, `username`, `role`).
 * @use Used by admin login and guarded routes.
 */
