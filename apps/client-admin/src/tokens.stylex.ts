/**
 * @file apps/client-admin/src/tokens.stylex.ts
 * @contents StyleX design tokens (colors, spacing, typography) for the app.
 * @use Imported by StyleX `style()` calls in components under the same app.
 */
