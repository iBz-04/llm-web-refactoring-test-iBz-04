/**
 * @file apps/client-user/src/server/functions/notifications.ts
 * @contents TanStack Start server function: bridges browser to gRPC for `notifications` operations.
 * @use Imported from client routes/components under the same app.
 */
