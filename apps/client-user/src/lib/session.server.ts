 ...
 * @contents TanStack Start encrypted cookie session (`userId`, `username`) for the user app.
 * @use Used by auth server functions and any route needing the logged-in user context.
 */
