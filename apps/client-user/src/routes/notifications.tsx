/**
 * @file apps/client-user/src/routes/notifications.tsx
 * @contents TanStack Router route module for URL segment `notifications.tsx`.
 * @use Rendered by the client router; may call server functions and shared UI components.
 */
