 ...
 * @contents HTTP API entry (Elysia): routes, health check, wiring to supporting services.
 * @use Node process entry for the `@chirp/api` package (`pnpm dev:api`, production start).
 */
