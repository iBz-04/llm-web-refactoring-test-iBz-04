/**
 * @file apps/api/src/grpc/handlers/__tests__/comments.handler.test.ts
 * @contents Vitest tests for the comments gRPC handler.
 * @use Executed by `pnpm --filter @chirp/api test`; validates handler behavior and auth edge cases.
 */
