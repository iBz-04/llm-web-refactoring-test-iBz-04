/**
 * @file apps/api/src/grpc/handlers/notifications.handler.ts
 * @contents gRPC service implementation for `notifications` RPCs (protobuf contract).
 * @use Registered in `grpc/server.ts`; invoked by `@chirp/grpc-client` from admin/user apps.
 */
