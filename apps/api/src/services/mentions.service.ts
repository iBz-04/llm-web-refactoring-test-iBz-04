/**
 * @file apps/api/src/services/mentions.service.ts
 * @contents Domain service: database queries and business rules for mentions.
 * @use Called from gRPC handlers (e.g. `mentions.handler.ts`) and sometimes other services.
 */
