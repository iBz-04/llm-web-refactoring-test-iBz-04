/**
 * @file apps/api/src/services/comments.service.ts
 * @contents Domain service: database queries and business rules for comments.
 * @use Called from gRPC handlers (e.g. `comments.handler.ts`) and sometimes other services.
 */
