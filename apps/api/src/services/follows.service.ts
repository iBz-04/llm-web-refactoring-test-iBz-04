/**
 * @file apps/api/src/services/follows.service.ts
 * @contents Domain service: database queries and business rules for follows.
 * @use Called from gRPC handlers (e.g. `follows.handler.ts`) and sometimes other services.
 */
