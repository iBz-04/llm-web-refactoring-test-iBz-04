/**
 * @file apps/api/src/services/notifications.service.ts
 * @contents Domain service: database queries and business rules for notifications.
 * @use Called from gRPC handlers (e.g. `notifications.handler.ts`) and sometimes other services.
 */
