/**
 * @file apps/api/src/services/likes.service.ts
 * @contents Domain service: database queries and business rules for likes.
 * @use Called from gRPC handlers (e.g. `likes.handler.ts`) and sometimes other services.
 */
